  ...
  (
    ...
    if (variant === 'link') {
      return (
        <Comp
          className={cn(
            'inline underline underline-offset-4 text-ink-black hover:text-ink-medium hover:no-underline hover:cursor-pointer transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink-black focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50',
            linkSizeClass,
            className,
          )}
          ref={ref}
